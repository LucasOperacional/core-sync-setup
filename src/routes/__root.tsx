...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NXS Sistemas" },
      { name: "description", content: "NXS Sistemas — gestão empresarial integrada" },
      { name: "author", content: "NXS Sistemas" },
      { name: "theme-color", content: "#17233D" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "NXS Sistemas" },
      { property: "og:title", content: "NXS Sistemas" },
      { property: "og:description", content: "Gestão empresarial integrada" },
