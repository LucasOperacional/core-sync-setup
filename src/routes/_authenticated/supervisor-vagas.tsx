...
import { SolicitacaoVagaForm } from "@/components/SolicitacaoVagaForm";
import { FloatingNav } from "@/components/FloatingNav";

export const Route = createFileRoute("/_authenticated/supervisor-vagas")({
  head: () => ({
    meta: [{ title: "Abertura de Vagas | Supervisor" }],
  }),
  component: SupervisorVagasPage,
});

function SupervisorVagasPage() {
  return (
