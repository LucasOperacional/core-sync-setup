    ...
    <main className="grid min-h-screen bg-background lg:grid-cols-[minmax(20rem,0.85fr)_minmax(28rem,1.15fr)]">
        ...
        <div className="relative hidden flex-col justify-between overflow-hidden border-r border-border bg-card p-10 lg:flex">
          ...
          <div className="relative z-10 flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-md bg-primary font-display text-sm font-bold text-primary-foreground">NX</span>
            <div>
              <p className="font-display text-sm font-semibold text-white">NXS GESTÃO</p>
              <p className="text-xs text-white/70">Central integrada com a sua Empresa</p>
            </div>
          </div>
          <div className="relative z-10 max-w-sm">
            <p className="text-xs font-semibold text-primary">AMBIENTE CORPORATIVO</p>
            <h1 className="mt-3 font-display text-3xl font-semibold leading-tight text-white">Controle com segurança e precisão.</h1>
            <p className="mt-4 text-sm leading-6 text-white/80">Acesse relatórios, protocolos, indicadores e fluxos autorizados para o seu perfil.</p>
          </div>
          <p className="relative z-10 text-xs text-white/60">Acesso protegido e monitorado.</p>
        </div>
