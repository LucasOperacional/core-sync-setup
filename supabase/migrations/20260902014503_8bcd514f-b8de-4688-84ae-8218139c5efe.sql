...
create policy "Users can update own messages" on public.ai_messages for update to authenticated using (auth.uid() = user_id);
...
create policy "Users can update own chat messages" on public.chat_messages for update to authenticated using (auth.uid() = user_id);
...
create policy "Users can update own reads" on public.chat_message_reads for update to authenticated using (auth.uid() = user_id);
