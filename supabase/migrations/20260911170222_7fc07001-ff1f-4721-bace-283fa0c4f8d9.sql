...
CREATE OR REPLACE FUNCTION private.security_check_rate_limit(
...
END;
$$;
GRANT EXECUTE ON FUNCTION private.security_check_rate_limit(text, text, integer, integer) TO authenticated, service_role;
